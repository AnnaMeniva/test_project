...
export const DragDropFilesPageForm: React.FC = ()=>{
    ...
    return(
        <form className={s.formAddFileWrapper} onDrop={(e)=>handleDrop(e)} onDragLeave={handleDrag} 
            onDragOver={handleDrag} onDragEnter = {handleDrag} onSubmit={(e) => e.preventDefault()}>
            <input ref={inputRef}  type="file" accept=".png, .jpg, .jpeg, .webp, .mp4, .mp3, .pdf" onChange={handleChange} />
            <label htmlFor="file">
            ...
            {dragActive && <div className={s.active} onDragEnter={handleDrag} onDragLeave={handleDrag} 
